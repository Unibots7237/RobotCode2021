...
public class Robot extends TimedRobot {
  ...
  public void testInit() {
    ...
    path.followPath(x -> {return Math.sqrt(25-((x-5)*(x-5)));}, 0.4, 0 ,10);

    SmartDashboard.putNumber("Left Encoder: ", auto.getLeft());
    SmartDashboard.putNumber("Right Encoder: ", auto.getRight());    
    SmartDashboard.putNumber("Left Encoder Vel.: ", auto.getLeftVel());
    SmartDashboard.putNumber("Right Encoder Vel.: ", auto.getRightVel());    
    SmartDashboard.putNumber("Yaw: ", drivebase.getYaw());
    SmartDashboard.putNumber("Yaw Vel.: ", drivebase.getVZ());
    SmartDashboard.putNumber("Yaw Acc.: ", drivebase.getAZ());
  }
  ...
  public void testPeriodic() {
    /*
    path.followPath(x -> {return (0);}, 0.4, 0 ,5);
